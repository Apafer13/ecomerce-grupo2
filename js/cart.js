...
/*function completarCarro() {
    ...
    for (let producto of carrito) {
        ...
        <td class="align-middle"><input type="button" onclick="borrar()" value="X" class="eliminar"></td>
        </tr>`;
    }
...
function borrar(){
    let paraBorrar = document.getElementsByClassName("eliminar");
    let carrito = JSON.parse(localStorage.getItem("Carrito"));
    let filas = document.getElementsByClassName('filas')
    for(let i =0; i < paraBorrar.length; i++){        
